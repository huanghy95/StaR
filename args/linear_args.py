...
def create_arg_parser():
    ...
    # Causal Discovery Enhancement arguments
    parser.add_argument('--causal_discovery', type=str, default='default', 
                       choices=['default', 'gated', 'attention'],
                       help='Causal discovery enhancement method (default: default)')

...
def create_arg_parser():
    """
    Creates and returns the argument parser for the MSL dataset.

    Returns:
        argparse.ArgumentParser: The argument parser for the MSL dataset.
    """
    parser = argparse.ArgumentParser(description='Mars Science Laboratory (MSL) Dataset')

    # Dataset arguments
    parser.add_argument('--num_vars', type=int, default=15, help='Number of features (default: 15)')
    parser.add_argument('--window_size', type=int, default=50, help='Window size for sequences (default: 50)')
    parser.add_argument('--selected_channels', type=str, nargs='*', default=None, 
                       help='Specific MSL channels to use (default: None - uses first 5)')
    ...
    parser.add_argument('--data_dir', type=str, default=os.path.join(os.getcwd(), 'datasets', 'SMAP_MSL'), 
                       help='Data directory (default: ./datasets/SMAP_MSL)')
    ...
    parser.add_argument('--dataset_name', type=str, default='msl', help='Dataset name (default: msl)')
